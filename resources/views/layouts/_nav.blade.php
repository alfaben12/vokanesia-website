      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <ul class="xs-list list-inline">
            <li><a href="https://www.facebook.com/vokanesia" target="_blank"><i class="icon icon-facebook"></i></a></li>
            <li><a href="https://twitter.com/vokanesia" target="_blank"><i class="icon icon-twitter"></i></a></li>
            <li><a href="https://www.instagram.com/vokanesia.id" target="_blank"><i class="icon icon-instagram"></i></a></li>
            <li><a href="https://www.youtube.com/channel/UCycepOpin1oi0tDET4Hx45g" target="_blank"><i class="icon icon-youtube-v"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
