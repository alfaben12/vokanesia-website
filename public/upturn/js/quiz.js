...
;(function($) {
  ...
  function render(quiz_opts) {
    ...
    */
    var $slides = $("<div>")
    .attr("class", "carousel-inner py-5")
    .attr("role", "listbox")
    .appendTo($quiz);
    ...
    */
    ...
    .attr('class', 'quiz-title my-0 py-0')
    .css("color", "black")
    ...
    $("<button>")
    .attr('class', 'quiz-button btn btn-primary')
    .text("START EXAM!")
    .click(function() {
      $quiz.carousel('next');
    ...
    */
    $.each(questions, function(question_index, question) {
      ...
      if (question.image) {
        ...
        .attr("class", "image-credit px-3")
        .appendTo($img_div);
      }
      $("<div>")
      .attr("class", "quiz-question px-3")
      ...
      $.each(question.answers, function(answer_index, answer) {
        ...
        var ans_col = $("<div>")
        .attr("class", "col-lg-6 col-12")
        .appendTo($answers);

        var ans_btn = $("<button>")
        .attr('class', 'quizbtn btn btn-primary btn-block my-3')
        .html(answer)
        .appendTo(ans_col);
    ...
    .attr('class', 'quiz-title my-0 py-3')
    .css("color", "black")
